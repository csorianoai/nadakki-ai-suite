...
# -*- coding: utf-8 -*-
"""
VentascrmCoordinator - Coordinador de 4 Agentes
...
from .churnpredictor import ChurnpredictorConfig
from .cierrepredictivoia import ClosingPredictionEngine
from .clientelifecycleia import CustomerLifecycleEngine
from .communicationbot import CommunicationBotEngine
from .leadscoringia import LeadscoringiaConfig
from .pipelineoptimizer import PipelineoptimizerConfig
from .pipelinepredictivoia import PredictivePipelineEngine
from .upsellengine import UpsellengineConfig
from .ventascrm_coordinator import VentascrmCoordinator
...
class VentascrmCoordinator:
    def __init__(self, tenant_config):
        self.tenant_id = tenant_config.get('tenant_id')
        self.module_name = 'ventascrm'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('ventascrm', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'PipelinePredictivoIA': {'class': PredictivePipelineEngine, 'performance': 92.8},
            'CierrePredictivoIA': {'class': ClosingPredictionEngine, 'performance': 88.5},
            'CommunicationBot': {'class': CommunicationBotEngine, 'performance': 86.2},
            'ClienteLifecycleIA': {'class': CustomerLifecycleEngine, 'performance': 90.7}
        }
