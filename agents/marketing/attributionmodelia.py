"""
AttributionModelIA v3.2.0 - ENTERPRISE SUPER AGENT
"""
...
AGENT_NAME = "AttributionModelIA"
AGENT_TYPE = "attribution_modeling"
SUPER_AGENT = True
...
class AttributionModelAgentOperative:
    def __init__(self):
...
OperativeMixin.bind(AttributionModelAgentOperative)
AttributionModelIA_operative = AttributionModelAgentOperative()
