...
class ContentPerformanceAgentOperative:
    def __init__(self):
...
OperativeMixin.bind(ContentPerformanceAgentOperative)
ContentPerformanceIA_operative = ContentPerformanceAgentOperative()
