...
# -*- coding: utf-8 -*-
"""
InteligenciaCoordinator - Coordinador de 4 Agentes
...
from .cashfloworacle import CashfloworacleConfig
from .inteligencia_coordinator import InteligenciaCoordinator
from .pricinggenius import PricinggeniusConfig
from .profitmaximizer import ProfitmaximizerConfig
from .roimaster import RoimasterConfig
...
class InteligenciaCoordinator:
    def __init__(self, tenant_config):
        self.tenant_id = tenant_config.get('tenant_id')
        self.module_name = 'inteligencia'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('inteligencia', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'ProfitMaximizer': {'class': ProfitMaximizerOptimizer, 'performance': 96.2},
            'CashFlowOracle': {'class': CashFlowOraclePredictor, 'performance': 94.7},
            'PricingGenius': {'class': PricingGeniusStrategy, 'performance': 93.1},
            'ROIMaster': {'class': ROIMasterCalculator, 'performance': 91.9}
        }
