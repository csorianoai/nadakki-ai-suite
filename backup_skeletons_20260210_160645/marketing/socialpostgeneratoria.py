"""
SocialPostGeneratorIA v3.2.0 - ENTERPRISE SUPER AGENT
"""
...
class SocialPostGeneratorAgentOperative:
    def __init__(self):
...
OperativeMixin.bind(SocialPostGeneratorAgentOperative)
SocialPostGeneratorIA_operative = SocialPostGeneratorAgentOperative()
