"""
CashOfferFilterIA v3.2.0 - ENTERPRISE SUPER AGENT
"""
...
class CashOfferFilterAgentOperative:
    def __init__(self):
...
OperativeMixin.bind(CashOfferFilterAgentOperative)
CashOfferFilterIA_operative = CashOfferFilterAgentOperative()
