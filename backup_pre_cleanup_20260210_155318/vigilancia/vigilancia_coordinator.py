...
# -*- coding: utf-8 -*-
"""
VigilanciaCoordinator - Coordinador de 4 Agentes
...
# Imports de agentes
from .earlywarning import Earlywarning
from .marketradar import Marketradar
from .portfoliosentinel import Portfoliosentinel
from .stresstester import Stresstester

logger = logging.getLogger(__name__)

class VigilanciaCoordinator:
    def __init__(self, tenant_config):
        self.tenant_id = tenant_config.get('tenant_id')
        self.module_name = 'vigilancia'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('vigilancia', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'EarlyWarning': {'class': Earlywarning, 'performance': 96.2},
            'MarketRadar': {'class': Marketradar, 'performance': 94.8},
            'PortfolioSentinel': {'class': Portfoliosentinel, 'performance': 97.5},
            'StressTester': {'class': Stresstester, 'performance': 95.3}
        }
