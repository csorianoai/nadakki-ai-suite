...
# -*- coding: utf-8 -*-
"""
PresupuestoCoordinator - Coordinador de 6 Agentes
...
from .analisisvarianza import VarianceAnalysisEngine
from .budgetoptimizer import BudgetoptimizerConfig
from .controlpresupuestario import BudgetControlEngine
from .costocentros import CostocentrosConfig
from .forecastingavanzado import AdvancedForecastingEngine
from .forecastingia import ForecastingiaConfig
from .optimizacionrecursos import ResourceOptimizationEngine
from .planificacionestrategica import StrategicPlanningEngine
from .presupuestomaestro import PresupuestomaestroConfig
from .presupuestopredictivoia import PredictiveBudgetEngine
from .presupuesto_coordinator import PresupuestoCoordinator
from .roipredictor import RoipredictorConfig
from .varianzaanalisis import VarianzaanalisisConfig
...
class PresupuestoCoordinator:
    def __init__(self, tenant_config):
        self.tenant_id = tenant_config.get('tenant_id')
        self.module_name = 'presupuesto'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('presupuesto', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'PresupuestoPredictivoIA': {'class': PredictiveBudgetEngine, 'performance': 94.7},
            'ControlPresupuestario': {'class': BudgetControlEngine, 'performance': 96.2},
            'PlanificacionEstrategica': {'class': StrategicPlanningEngine, 'performance': 92.8},
            'OptimizacionRecursos': {'class': ResourceOptimizationEngine, 'performance': 90.5},
            'AnalisisVarianza': {'class': VarianceAnalysisEngine, 'performance': 93.1},
            'ForecastingAvanzado': {'class': AdvancedForecastingEngine, 'performance': 91.7}
        }
