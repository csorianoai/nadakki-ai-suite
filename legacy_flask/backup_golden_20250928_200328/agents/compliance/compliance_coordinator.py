...
# -*- coding: utf-8 -*-
"""
ComplianceCoordinator - Coordinador de 5 Agentes
...
# Imports de agentes
from .auditmaster import Auditmaster
from .compliancewatchdog import Compliancewatchdog
from .docguardian import Docguardian
from .regulatory_radar import RegulatoryRadar
from .regulatoryradar import Regulatoryradar
...
class ComplianceCoordinator:
    def __init__(self, tenant_config):
        ...
        self.module_name = 'compliance'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('compliance', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'AuditMaster': {'class': Auditmaster, 'performance': 98.9},
            'ComplianceWatchdog': {'class': Compliancewatchdog, 'performance': 97.6},
            'DocGuardian': {'class': Docguardian, 'performance': 96.4},
            'RegulatoryRadar': {'class': RegulatoryRadar, 'performance': 95.8},
            'RegulatoryRadarAlt': {'class': Regulatoryradar, 'performance': 95.8}
        }
