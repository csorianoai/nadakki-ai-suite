...
# -*- coding: utf-8 -*-
"""
OriginacionCoordinator - Coordinador de 4 Agentes
...
# Imports de agentes - CORREGIDOS
from .sentinelbot import Sentinelbot
from .dnaprofiler import Dnaprofiler
from .incomeoracle import Incomeoracle
from .behaviorminer import Behaviorminer
...
class OriginacionCoordinator:
    def __init__(self, tenant_config):
        ...
        self.module_name = 'originacion'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('originacion', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'SentinelBot': {'class': Sentinelbot, 'performance': 97.2},
            'DNAProfiler': {'class': Dnaprofiler, 'performance': 98.1},
            'IncomeOracle': {'class': Incomeoracle, 'performance': 95.7},
            'BehaviorMiner': {'class': Behaviorminer, 'performance': 96.3}
        }
