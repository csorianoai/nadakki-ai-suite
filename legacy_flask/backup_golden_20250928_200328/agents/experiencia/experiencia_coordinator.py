...
# -*- coding: utf-8 -*-
"""
ExperienciaCoordinator - Coordinador de 4 Agentes
...
from .chatbotsupreme import ChatbotsupremeConfig
from .customergenius import CustomergeniusConfig
from .experiencia_coordinator import ExperienciaCoordinator
from .onboardingwizard import OnboardingwizardConfig
from .personalizationengine import PersonalizationengineConfig
...
class ExperienciaCoordinator:
    def __init__(self, tenant_config):
        self.tenant_id = tenant_config.get('tenant_id')
        self.module_name = 'experiencia'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('experiencia', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'CustomerGenius': {'class': CustomerGeniusPersonalizer, 'performance': 93.6},
            'PersonalizationEngine': {'class': PersonalizationEngineCore, 'performance': 91.8},
            'ChatbotSupreme': {'class': ChatbotSupremeAI, 'performance': 89.4},
            'OnboardingWizard': {'class': OnboardingWizardGuide, 'performance': 88.2}
        }
