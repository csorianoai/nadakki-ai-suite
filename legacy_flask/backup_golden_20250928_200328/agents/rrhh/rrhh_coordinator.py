...
# -*- coding: utf-8 -*-
"""
RrhhCoordinator - Coordinador de 5 Agentes
...
from .capacitacionia import CapacitacioniaConfig
from .cvanalyzeria import CvanalyzeriaConfig
from .nominaautomatica import NominaautomaticaConfig
from .nominainteligente import IntelligentPayrollEngine
from .performanceanalyzer import PerformanceAnalysisEngine
from .performancetracker import PerformancetrackerConfig
from .rrhh_coordinator import RrhhCoordinator
from .selectioncvia import CVSelectionEngine
from .talentoprediccion import TalentPredictionEngine
from .talentopredictor import TalentopredictorConfig
...
class RrhhCoordinator:
    def __init__(self, tenant_config):
        self.tenant_id = tenant_config.get('tenant_id')
        self.module_name = 'rrhh'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('rrhh', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'SelectionCVIA': {'class': CVSelectionEngine, 'performance': 91.3},
            'NominaInteligente': {'class': IntelligentPayrollEngine, 'performance': 98.7},
            'PerformanceAnalyzer': {'class': PerformanceAnalysisEngine, 'performance': 89.4},
            'TalentoPrediccion': {'class': TalentPredictionEngine, 'performance': 87.6},
            'CapacitacionIA': {'class': TrainingAIEngine, 'performance': 85.9}
        }
