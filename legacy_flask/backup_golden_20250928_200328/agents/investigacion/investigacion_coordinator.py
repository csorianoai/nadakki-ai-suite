...
# -*- coding: utf-8 -*-
"""
InvestigacionCoordinator - Coordinador de 4 Agentes
...
from .analisistendencias import TrendAnalysisEngine
from .innovacionia import InnovationAIEngine
from .innovaciontracker import InnovaciontrackerConfig
from .investigacion_coordinator import InvestigacionCoordinator
from .patentesanalyzer import PatentesanalyzerConfig
from .patentesautomaticos import AutomaticPatentEngine
from .prototipogenerator import PrototipogeneratorConfig
from .prototiposgenerativos import GenerativePrototypeEngine
from .tendenciasia import TendenciasiaConfig
...
class InvestigacionCoordinator:
    def __init__(self, tenant_config):
        self.tenant_id = tenant_config.get('tenant_id')
        self.module_name = 'investigacion'
        self.agents = {}
        self.enabled_agents = tenant_config.get('enabled_agents', {}).get('investigacion', [])
    ...
    def _initialize_agents(self, tenant_config):
        ...
        agent_mappings = {
            'InnovacionIA': {'class': InnovationAIEngine, 'performance': 87.3},
            'PatentesAutomaticos': {'class': AutomaticPatentEngine, 'performance': 91.8},
            'PrototiposGenerativos': {'class': GenerativePrototypeEngine, 'performance': 84.6},
            'AnalisisTendencias': {'class': TrendAnalysisEngine, 'performance': 89.2}
        }
